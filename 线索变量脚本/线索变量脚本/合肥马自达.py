...
# ================= 读取 Excel =================
df = pd.read_excel(r"/Users/tangtangtang/工作/冰兰智能/建银-线索处理/合肥马自达/2509.xlsx")
...
for index, row in df.iterrows():
    ...
    possible_date_columns = ['最后进厂日期', '进厂时间', '最后维修日期', '最后保养日期']
...
# ================= 保存文件 =================
save_path = r'/Users/tangtangtang/工作/冰兰智能/建银-线索处理/合肥马自达/2509.txt'
