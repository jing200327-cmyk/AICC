...
# ================= 读取 Excel =================
df = pd.read_excel(r"C:\Users\Grace\Desktop\日期.xlsx")
...
for index, row in df.iterrows():
    ...
    possible_date_columns = ['最后一次进厂日期', '最后进厂', '最后维修日期', '最后保养日期','最后一次进场时间']
    ...
    possible_mileage_columns = ['进厂行驶里程', '行驶里程', '进厂里程', '里程','最近一次保养进厂公里数']
...
# ================= 保存文件 =================
save_path = r'C:\Users\Grace\Desktop\车辆信息1.txt'
