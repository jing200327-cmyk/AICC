...
# ================= 读取 Excel =================
df = pd.read_excel(r"/Users/tangtangtang/工作/冰兰智能/建银-线索处理/襄阳林肯/26年4月23日AI外呼名单.xls")
...
for index, row in df.iterrows():
    ...
    possible_date_columns = ['进厂日期', '最后进厂', '最后维修日期', '上次进厂时间']
...
# ================= 保存文件 =================
save_path = r'/Users/tangtangtang/工作/冰兰智能/建银-线索处理/襄阳林肯/26年4月23日AI外呼名单.txt'
